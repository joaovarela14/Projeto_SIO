...
echo "Assuming Managers role..."
python3 client.py rep_assume_role "$SESSION_FILE" "Managers"
check_command "Assume Managers role"
...
python3 client.py rep_get_doc_metadata "$SESSION_FILE" "$DOCUMENT_NAME" > "$METADATA_FILE"
