...
def encrypt_document_key(doc_key, recipient_public_key_content, sender_password, sender_salt):
    ...
    # Return the encrypted document key and IV
    return encrypted_doc_key, iv


def decrypt_document_key(encrypted_doc_key, iv, recipient_password, recipient_salt, sender_public_key_content):
    """
